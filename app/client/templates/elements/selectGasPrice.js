...
var calculateGasInWei = function(template, gas, gasPrice, returnGasPrice){
    ...
    if(_.isUndefined(gas)) {
        console.warn('No gas provided for {{> selectGasPrice}}');
...
Template['selectGasPrice'].onCreated(function(){
...
Template['selectGasPrice'].helpers({
    /**
    ...
    */
    ...
    /**
    Return the current display unit
    @method (displayUnit)
    */
...
Template['selectGasPrice'].events({
    /**
